// Vendored from ../zellij-modal/index.ts to keep pi-tool-codex standalone.
...
const MODAL_BORDER_COLOR: PaletteColor = { type: "rgb", r: 114, g: 115, b: 115 };
...
export const DEFAULT_ZELLIJ_PALETTE: ZellijColorPalette = {
	...
	borderFocused: MODAL_BORDER_COLOR,
	borderUnfocused: MODAL_BORDER_COLOR,
};
